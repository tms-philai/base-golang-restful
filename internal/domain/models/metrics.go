...
type Metrics struct {
	...
	TotalDuration    time.Duration              `json:"total_duration" swaggerignore:"true"`
	AverageDuration  time.Duration              `json:"average_duration" swaggerignore:"true"`
...
type EndpointMetric struct {
	...
	ErrorCount    int64         `json:"error_count"`
	TotalDuration time.Duration `json:"total_duration" swaggerignore:"true"`
	AvgDuration   time.Duration `json:"avg_duration" swaggerignore:"true"`
	MinDuration   time.Duration `json:"min_duration" swaggerignore:"true"`
	MaxDuration   time.Duration `json:"max_duration" swaggerignore:"true"`
}
