...
import (
	"base-gin/internal/app/observers"
...
type NotificationHandler struct {
	...
	inAppChannel        *observers.InAppChannel
}

func NewNotificationHandler(notificationService *services.NotificationService, inAppChannel *observers.InAppChannel) *NotificationHandler {
...
func (h *NotificationHandler) GetNotifications(c *gin.Context) {
	...
	notifications, err := h.inAppChannel.GetNotifications(c.Request.Context(), userID, 100, 0)
	if err != nil {
		c.JSON(http.StatusInternalServerError, models.ErrorResponse{
...
func (h *NotificationHandler) MarkAsRead(c *gin.Context) {
	...
	if err := h.inAppChannel.MarkAsRead(c.Request.Context(), notificationID); err != nil {
